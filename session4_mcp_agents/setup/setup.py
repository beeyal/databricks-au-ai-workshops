...
def check_pt_endpoint(endpoint_name: str, host: str, token: str) -> None:
    ...
    if resp.status_code == 404:
        ...
        print("  5. Model:  select 'gpt-oss-120b' (in-region in AU East + reliable tool calls;")
        print("             avoid Llama here — it is cross-geo in AU East)")
...
print(f"    {vs_mcp_url}")
print()
print(f"  Vector Search index name (the labs build the VS MCP URL from this automatically):")
