...
Governing legislation: Australian data residency requirements (critical infrastructure), Privacy Act 1988, National Electricity Rules (NER), AER.
...
## Data classification
Data in this workspace may include Critical Infrastructure data under the Australian data residency requirements.
