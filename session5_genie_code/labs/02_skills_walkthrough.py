...
Formula: SAIDI = Σ(duration_minutes × affected_customers) / total_customers
...
# MAGIC
# MAGIC This skill gives Genie Code awareness of AEMO's specific regulatory obligations under the Australian regulatory requirements,
# MAGIC Privacy Act, and AER performance schemes — and provides compliance-oriented SQL patterns.
# MAGIC
# MAGIC **When it loads:** any mention of Australian regulatory requirements, Privacy Act, AER, compliance, NER, STPIS, obligations.

# COMMAND ----------

regulatory_compliance_skill = """---
name: regulatory-compliance
description: AEMO and AER regulatory compliance context — Australian regulatory requirements critical infrastructure obligations, Privacy Act NMI data handling, NER Chapter 7 retention, STPIS incentive scheme, and compliance SQL patterns for AEMO operations
---

# AEMO Regulatory Compliance Context

## Australian data residency requirements (Security of Critical Infrastructure)
AEMO is designated as a critical infrastructure entity under the Australian data residency requirements.
...
# MAGIC ```
# MAGIC @regulatory-compliance What are AEMO's Australian regulatory requirements obligations for AI systems processing NEM data?
# MAGIC ```
# MAGIC Expected: Genie loads the skill via `@` and returns the Australian regulatory requirements section covering
